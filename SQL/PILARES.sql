                     ...
                     FROM PEDID P
                       INNER JOIN CLI C ON C.CLICODIGO=P.CLICODIGO
                        WHERE  PEDSITPED<>'C' AND PEDLCFINANC IN ('S', 'L','N') AND PEDDTBAIXA BETWEEN
                          DATEADD(MONTH, -12, CURRENT_DATE - EXTRACT(DAY FROM CURRENT_DATE) + 1) AND 'TODAY' OR  PEDDTBAIXA BETWEEN DATEADD(MONTH, -12,DATEADD(YEAR, -1, CURRENT_DATE) - EXTRACT(DAY FROM CURRENT_DATE) + 1) AND DATEADD(YEAR, -1, CURRENT_DATE)),
