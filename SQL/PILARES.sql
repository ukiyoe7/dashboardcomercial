  ...
  PED AS (SELECT P.ID_PEDIDO,
             ...
             DATEADD(YEAR, -1, CAST(EXTRACT(YEAR FROM CURRENT_DATE) || '  -01-01' AS DATE)) AND
                            ...
                            PEDDTBAIXA BETWEEN 
               DATEADD(MONTH, -5, CURRENT_DATE - EXTRACT(DAY FROM CURRENT_DATE) + 1) AND CURRENT_DATE - EXTRACT(DAY FROM CURRENT_DATE) OR
                PEDDTBAIXA BETWEEN DATEADD(MONTH, -5,DATEADD(YEAR, -1, CURRENT_DATE) - EXTRACT(DAY FROM CURRENT_DATE-1) + 1) AND DATEADD(YEAR, -1, CURRENT_DATE - EXTRACT(DAY FROM CURRENT_DATE))      
                           )),
